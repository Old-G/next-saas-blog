export default function loading() {
	return (
		<div className='flex flex-col'>
			<div className='w-full border rounded-md dark:bg-gradient-dark p-5 hover:ring-2 ring-green-500 transition-all cursor-pointer space-y-5 first:lg:col-span-2 first:md:col-span-3'>
